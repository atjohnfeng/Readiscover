...
attack_on_titan = Book.create(title: 'Attack on Titan Vol. 1', author: 'Hajime Isayama', page_count: 193, published_count: 'July 19, 2012', description: 'For the past century, what\'s left of mankind has hidden in a giant, three-walled city, trapped in fear of the bizarre, giant humanoids known as the Titans. Little is known about where they came from or why they are bent on consuming humankind, but the sudden appearance of an enormous Titan is about to change everything...', cover_img_url: 'https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1432712438l/13154150._SX318_.jpg')
